...
import com.uzlahpri.recipedia.databinding.FavoriteRecipesRowLayoutBinding
import com.uzlahpri.recipedia.ui.favorites.FavoriteRecipesFragmentDirections
...
class FavoriteRecipesAdapter (
    ...
    private fun applySelection(holder: MyViewHolder, currentRecipe: FavoritesEntity) {
        if (selectedRecipes.contains(currentRecipe)) {
            ...
            changeRecipeStyle(holder, R.color.cardBackgroundLightColor, R.color.green_primary)
            applyActionModeTitle()
        }
    }
